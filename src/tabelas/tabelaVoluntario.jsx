...
export default function TabelaEntregas(props){
    ...
    return(
        <Container className="mt-5 mb-5">
            <h3 className="d-flex justify-content-center align-items-center"><strong>Voluntario confirmado</strong></h3>
            ...
            <thead>
                <tr>
                <th>ID</th>
                <th><center>Nome do voluntario</center></th>
                <th><center>Data da boa ação</center></th>
                <th><center>Hora de chegada</center></th>
                <th><center>Hora de saida</center></th>
            ...
            <Modal show={showHelpModal} onHide={fecharAjudaModal}>
                <Modal.Header closeButton>
                    <Modal.Title><strong><center>Informações deste formulário</center></strong></Modal.Title>
                </Modal.Header>
                <Modal.Body>
                Este formulário permite gerenciar e cadastrar voluntarios.
                    <br></br>
                    <br></br>
                    <strong>Cadastrar voluntarios</strong>
                    <br></br>
                    Utilizando o botão Cadastrar você acessa o formulário, onde você irá inserir todos os dados necessários para cadastrar um novo voluntario.
                    <br></br>
                    <br></br>
                    <strong>Editar</strong>
                    <br></br>
                    Você utiliza o botão com uma imagem de lapis, voce sera redirecionado para o formulario de um voluntario ja cadastrado e podera atualizar ou alterar dados.
                    <br></br>
                    <br></br>
                    <strong>Excluir</strong>
                    <br></br>
                    Você utiliza o botão com a imagem de uma lixeira para a excluzão de algum voluntario, caso necessite.
                    <br></br>
                    <br></br>
                    <strong>Pesquisa</strong>
                    <br></br>
                    Você utiliza a barra de pesquisa para buscar um voluntario pela data.
                    <br></br>
                    <br></br>
                    <strong>PDF</strong>
                    <br></br>
                    Você utiliza o botão com a  PDF localizado abaixo do botão de cadastrar, onde vc pode imprimir ou salvar um documento.
                </Modal.Body>
                <Modal.Footer>
...
<center><button id="btnImprimir" onClick={imprimir} className="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
