    ...
    return (
        <Container className="mt-5 mb-5">
                            ...
                            return <tr key={turma.registro}>
                                ...
                                <td id='btnCaixa'>
                                    <div className="d-flex">
                                        <Button id='btnEdita' variant="info" onClick={() => { props.editarturma(turma) }}> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil" viewBox="0 0 16 16">
                                            <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z" />
                                        </svg> </Button>
                                        <Button id='btnExclui' variant="danger" onClick={() => { props.excluir(turma) }} className="ms-2"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash3" viewBox="0 0 16 16">
            ...
            <Modal show={showHelpModal} onHide={fecharAjudaModal}>
                ...
                <Modal.Body>
                    Este formulário permite gerenciar e cadastrar Turmas. Estes são os recursos:
                    <br></br>
                    <br></br>
                    <strong>Cadastrar Turma</strong>
                    <br></br>
                    Utilizando o botão Cadastrar, você acessa o formulário, onde você irá inserir todos os dados necessários para cadastrar uma nova Turma.
                    <br></br>
                    <br></br>
                    <strong>Editar</strong>
                    <br></br>
                    Você utiliza o botão com uma imagem de lapis, cujo irá redirecionar você ao formulário da Turma selecinado e então fará as alterações da Turma já cadastrado.
                    <br></br>
                    <br></br>
                    <strong>Excluir</strong>
                    <br></br>
                    Você utiliza o botão com a imagem de uma lixeira para pode fazer a excluzão da Turma selecionada.
                    <br></br>
                    <br></br>
                    <strong>Pesquisa</strong>
                    <br></br>
                    Você utiliza a barra de pesquisa para poder vizualizar apenas a Turma que você estiver buscando através da Data.
                    <br></br>
                    <br></br>
                    <strong>PDF</strong>
                    <br></br>
                    Você utiliza o botão com a imagem de PDF, localizado abaixo do botão de Cadastrar. Selecionando o botão PDF você pode baixar os dados de todas as Turmas cadastradas.
