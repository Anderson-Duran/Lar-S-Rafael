...
export default function TabelaPedidos(props){
    ...
    return(
        <Container className="mt-5 mb-5">
            <h3 className="d-flex justify-content-center align-items-center"><strong>Valores registrados</strong></h3>
            ...
            <Modal show={showHelpModal} onHide={fecharAjudaModal}>
                ...
                <Modal.Body>
                    Este formulário permite gerenciar e cadastrar doações.
                    <br></br>
                    <br></br>
                    <strong>Cadastrar valores</strong>
                    <br></br>
                    Utilizando o botão Cadastrar, você acessa o formulário, onde você irá doar um valor desejado.
                    <br></br>
                    <br></br>
                    <strong>Editar</strong>
                    <br></br>
                    Você utiliza o botão com uma imagem de lapis, cujo irá redirecionar você ao formulário de doação para fazer as devidas alterações.
                    <br></br>
                    <br></br>
                    <strong>Excluir</strong>
                    <br></br>
                    Você utiliza o botão com a imagem de uma lixeira para excluir um valor nao desejado.
                    <br></br>
                    <br></br>
                    <strong>Pesquisa</strong>
                    <br></br>
                    Você utiliza a barra de pesquisa para encontar um valor cadastrado.
                    <br></br>
                    <br></br>
                    <strong>PDF</strong>
                    <br></br>
