                    ...
                    return <tr key={categoria.codigoCat} id="linha">
                            ...
                            <td id="btn">
                                <div className="d-flex">
                                    ...
                                    <Button variant="danger" onClick={()=>{ props.excluir(categoria) }} className="ms-2"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash3" viewBox="0 0 16 16">
